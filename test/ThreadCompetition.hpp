...
public:
    ...
    auto enqueue(F&& Func, Args&&... ParamArgs, const size_t& ThreadId) -> std::future<typename std::result_of<F(Args...)>::type>;
...
template <class F, class... Args>
auto ThreadCompetition::enqueue(F&& Func, Args&&... ParamArgs, const size_t& ThreadId)
